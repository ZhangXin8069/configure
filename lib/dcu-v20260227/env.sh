...
# pip install -i https://mirrors.tuna.tsinghua.edu.cn/pypi/web/simple ninja pytest mpi4py h5py numpy==1.26.4 --resume-retries 10
...
# pip install torch-2.7.1+das.opt1.dtk25042-cp310-cp310-manylinux_2_28_x86_64.whl -i https://mirrors.tuna.tsinghua.edu.cn/pypi/web/simple
